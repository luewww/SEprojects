...
public class TransportService {
	...
	public ArrayList<MatchedTransport> readMatchedTransport() {
		...
		try (ObjectInputStream ois = new ObjectInputStream(new FileInputStream(
				...
				FileInputStream fis = new FileInputStream("MatchedTransports.txt");) {
	...
	public ArrayList<MatchedTransport> readMatchedTransportFromDB()
	{
		...
		try {
			...
			+"WHERE m.sendid=s.id AND m.transid=t.id AND receiveid=r.id";
			...
			while(rs.next())
			{
				...
				MatchedTransport  matchTran = new MatchedTransport(send,trans,receive);
				matchTrans.add(matchTran);
